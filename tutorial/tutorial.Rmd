...
## 2.2 Empirical data: Support comparisons
...
## 2.3 Empirical data: Branch length comparisons

## 2.4 Empirical data: Topological distances
...
plot(tree1_pruned, main = "Tree 1", cex = 1, edge.width = 2)
edgelabels(round(tree1_pruned$edge.length, 3), cex = 0.8)  # show branch lengths

plot(tree2_pruned, main = "Tree 2", cex = 1, edge.width = 2)
edgelabels(round(tree2_pruned$edge.length, 3), cex = 0.8)

# Function to extract clades, node indices, edge length, and edge type
compareBranchLength <- function(tree) {
...
# View merged clade-edge-length table
df_merged
```
