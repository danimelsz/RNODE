...
Another option is mapping branch lengths. We can map branch lengths to the strict consensus either using the minimum values from a pool of MPTs or randomly selecting one of the MPTs.
