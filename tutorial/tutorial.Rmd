...
For instance, using the data set from Geisler et al. (2011), we can plot the relationship of bootstrap values between molecular (MOL) and total evidence (TE) trees analyzed in TNT.
